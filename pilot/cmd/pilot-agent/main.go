...
var (
	...
	proxyCmd = &cobra.Command{
		...
		RunE: func(c *cobra.Command, args []string) error {
			...
			sdsEnabled, sdsTokenPath := detectSds(sdsUdsPathVar.Get(), sdsTrustworthyJWTPathVar.Get(), jwtPath)
...
func detectSds(udspath, preferJwtpath, jwtpath string) (bool, string) {
