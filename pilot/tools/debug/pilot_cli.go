...
func main() {
	...
	resources := flag.String("res", "httpbin-7fb7d5ddf-hdz7s", "Resource(s) to get config for. Should be pod name or app label or istio label for lds and cds type. For eds, it is comma separated list of cluster name.")
