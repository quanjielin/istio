...
func main() {
	...
	configType := flag.String("type", "cds", "lds, cds, or eds. Default lds.")
	proxyType := flag.String("proxytype", "", "sidecar, ingress, router.")
	resources := flag.String("res", "httpbin-7494d5bdd4-xhcj6", "Resource(s) to get config for. Should be pod name or app label or istio label for lds and cds type. For eds, it is comma separated list of cluster name.")
