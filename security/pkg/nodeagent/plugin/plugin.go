...
const (
	// Authn is the name of the google IAM plugin.
	GoogleIAM = "GoogleIAM"
)
...
type Plugin interface {
	ExchangeToken(ctx context.Context, trustedDomain, inputToken string) (string /*outputToken*/, time.Time /*expireTime*/, error)
}
